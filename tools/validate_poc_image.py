...
def main():
    ...
    try:
        ...
        if lock['product']['candidate'] in ('private-engineering-poc3','private-engineering-poc4','private-engineering-rc1','private-engineering-rc2','private-engineering-rc3','private-engineering-rc4','release'):
