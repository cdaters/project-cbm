 ...
 try:
  with tempfile.TemporaryDirectory(dir=a.output.parent) as tmp:
   ...
   try:
    ...
    single_user=json.loads(text('usr/share/project-cbm/identity.json'))['product']['candidate'] in ('private-engineering-rc2','private-engineering-rc3','private-engineering-rc4','release')
