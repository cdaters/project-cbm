...
class RC2(unittest.TestCase):
 def test_factory_defaults_use_actual_strict_reader_and_correct_image_name(self):
  ...
  self.assertEqual(defaults['boot_presentation']['primary_dwell_milliseconds'],1500)
  self.assertEqual(read_json(ROOT/'build/pigen/config.json')['image_name'],'project-cbm-1.1.0-rc.2')
