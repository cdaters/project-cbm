...
RESULTS = {'saved_restart': 'Keyboard layout saved. It applies after reboot; current console input is unchanged.', 'credentials_required': 'Set a separate File Sharing password before turning it on.', 'ok': 'Setting applied.', 'invalid': 'The value is not supported. Check the setting and try again.',
